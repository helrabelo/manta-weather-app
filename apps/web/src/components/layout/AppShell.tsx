...
export function AppShell({ header, main, footer }: AppShellProps) {
  return (
    <div className="min-h-screen grid grid-rows-[auto_1fr_auto] transition-colors duration-700">
      ...
      <header className="flex flex-col gap-3 px-4 pt-4 pb-2 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-4 md:px-10 md:py-6">
        {header}
      </header>

      <main id="main-content" className="flex items-start justify-center px-4 pb-8 sm:px-6 overflow-y-auto">
        {main}
      </main>

      <footer className="px-4 pb-6 sm:px-6 md:px-10 md:pb-8">
        {footer}
      </footer>
    </div>
  )
